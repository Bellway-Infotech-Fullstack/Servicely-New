...
*/
 ...
 Route::group(['namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'services'], function () {
        Route::get('latest', 'ServiceController@get_latest_products');
        Route::get('popular', 'ServiceController@get_popular_products');
        Route::get('most-reviewed', 'ServiceController@get_most_reviewed_products');
        Route::get('set-menu', 'ServiceController@get_set_menus');
        Route::get('search', 'ServiceController@get_searched_products');
        Route::get('details/{id}', 'ServiceController@get_product');
        Route::get('related-products/{service_id}', 'ServiceController@get_related_products');
        Route::get('reviews/{service_id}', 'ServiceController@get_product_reviews');
        Route::get('rating/{service_id}', 'ServiceController@get_product_rating');
        Route::post('reviews/submit', 'ServiceController@submit_product_review')->middleware('auth:api');
    });



    Route::group(['prefix' => 'vendors'], function () {
        Route::get('get-vendors/{filter_data}', 'VendorController@get_restaurants');
        Route::get('latest', 'VendorController@get_latest_restaurants');
        Route::get('popular', 'VendorController@get_popular_restaurants');
        Route::get('details/{id}', 'VendorController@get_details');
        Route::get('reviews', 'VendorController@reviews');
        Route::get('search', 'VendorController@get_searched_restaurants');
    });
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('vendors/{category_id}', 'CategoryController@get_restaurants');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::get('suggested-services', 'CustomerController@get_suggested_food');
        ...
        Route::group(['prefix' => 'address'], function () {
         ...
         Route::group(['prefix' => 'wallet', 'middleware' => 'auth:api'], function () {
            Route::post('fund_wallet', 'WalletController@fund_wallet');
        });

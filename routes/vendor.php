...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'service', 'as' => 'service.', 'middleware' => ['module:food']], function () {
        ...
        Route::group(['prefix' => 'my-wallet', 'as' => 'wallet.', 'middleware' => ['module:wallet']], function () {
        ...
        Route::group(['prefix' => 'business-section', 'as' => 'business-settings.', 'middleware' => ['module:restaurant_setup']], function () {
            Route::get('vendor-config', 'BusinessSettingsController@restaurant_index')->name('restaurant-setup');
        });
        ...
        Route::group(['prefix' => 'business-section', 'as' => 'profile.', 'middleware' => ['module:bank_info']], function () {
            ...
            Route::get('kyc-details', 'ProfileController@bank_view')->name('bankView');

            Route::get('kyc-edit', 'ProfileController@kyc_edit')->name('kycEdit');
            Route::post('kyc-update', 'ProfileController@kyc_update')->name('kyc_update');

                                ...
                                <label class="input-label" for="exampleFormControlSelect1"><?php echo e(__('messages.restaurant')); ?><span
                                 ...
                                 class="form-control">
                                            ...
                                            <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($product->vendor_id == $vendor->id): ?>
                                                      <option value="<?php echo e($vendor->id); ?>" selected="selected"><?php echo e($vendor->names()); ?></option>
                                                <?php else: ?>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" value="<?php echo e($product['available_time_ends']); ?>"
                                       name="available_time_ends" class="form-control" max="<?php echo e($closing_time); ?>" id="available_time_ends" placeholder="5:45 pm"
                                       required>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequest('<?php echo e(url('/')); ?>/admin/food/get-categories?parent_id=' + sub_category + '&&sub_category=' + sub_sub_category, 'sub-sub-categories');
            
            }, 1000)
            <?php if(count(json_decode($product['add_ons'], true))>0): ?>
            getRestaurantData('<?php echo e(url('/')); ?>/admin/vendor/get-addons?vendor_id=<?php echo e($product['vendor_id']); ?><?php $__currentLoopData = json_decode($product['add_ons'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>&data[]=<?php echo e($addon); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>','add_on');
            <?php else: ?>
            getRestaurantData('<?php echo e(url('/')); ?>/admin/vendor/get-addons?data[]=0&vendor_id=<?php echo e($product['vendor_id']); ?>','add_on');
            <?php endif; ?>
        });
    </script>
    ...
    <script>
        $('#product_form').on('submit', function () {
            ...
            $.post({
                url: '<?php echo e(route('admin.service.update',[$product['id']])); ?>',
                data: $('#product_form').serialize(),
                data: formData,
                cache: false,
                contentType: false,
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/admin-views/product/edit.blade.php ENDPATH**/ ?>
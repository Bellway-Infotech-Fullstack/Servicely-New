    ...
    <div class="row justify-content-between align-items-center">
        <div class="col">
            <p class="font-size-sm mb-0">
                ...
                <span
                    class="d-none d-sm-inline-block"><?php echo \App\Models\BusinessSetting::where(['key'=>'footer_text'])->first()->value; ?></span>
            </p>
        </div>
        <div class="col-auto">
...
<?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/layouts/admin/partials/_footer.blade.php ENDPATH**/ ?>
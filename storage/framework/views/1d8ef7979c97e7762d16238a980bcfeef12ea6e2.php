<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tr class="status-<?php echo e($order['order_status']); ?> class-all">
        ...
        <td>
            <label class="badge badge-soft-primary"><?php echo e($order->vendor?$order->vendor->names() : 'Vendor deleted!'); ?></label>
        </td>
        <td>
...
<?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/admin-views/order/partials/_table.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <!-- Title -->
    <title><?php echo e(__('messages.vendor')); ?> | <?php echo e(__('messages.login')); ?></title>
...
<main id="content" role="main" class="main">
    <div class="position-fixed top-0 right-0 left-0 bg-img-hero"
         style="height: 100%; background-image: url(<?php echo e(asset('public/assets/admin/img/vendor-bg.png')); ?>);background-position: bottom;"
         >
    </div>
    ...
    <div class="container py-0">
        ...
        <header class="position-relative d-flex flex-column flex-md-row justify-content-between p-3 mb-5">
            <div class="font-weight-bold order-2 order-md-1">
                <img class="z-index-2" src="<?php echo e(asset('public/assets/admin/img/hello.png')); ?>" style="max-height: 50px;max-width: 200px">
            ...
            <a class="d-flex justify-content-center mb-5 order-1 order-md-2" href="javascript:">
                <img class="z-index-2" src="<?php echo e(asset('public/assets/admin/img/logo_white.png')); ?>"
                    ...
                    <div class="card-body">
                        ...
                        <form class="login_form" action="<?php echo e(route('vendor.auth.login')); ?>" method="post" id="vendor_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4"><?php echo e(__('messages.vendor_owner_login_form')); ?></span>
                                </div>
                            </div>
                            <div class="js-form-message form-group">
                                <label class="input-label" for="signinSrEmail"><?php echo e(__('messages.your_email')); ?></label>
                        ...
                        <form class="login_form" action="<?php echo e(route('vendor.auth.employee.login')); ?>" method="post" id="employee_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4"><?php echo e(__('messages.vendor_employee_login_form')); ?></span>
                                </div>
                            </div>
                            <!-- Form Group -->
                            <div class="js-form-message form-group">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg"
                                           name="password"  placeholder="<?php echo e(__('messages.password_length_placeholder', ['length'=>'8+'])); ?>"
                                           aria-label="8+ characters required" required
                                           data-msg="<?php echo e(__('messages.invalid_password_warning')); ?>"
                                           data-hs-toggle-password-options='{
                                ...
                                <div class="row p-2">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control form-control-lg" name="custome_recaptcha"
                                               id="custome_recaptcha" required placeholder="<?php echo e(\__('Enter recaptcha value')); ?>" style="border: none" autocomplete="off">
                                    </div>
        ...
        <footer class="d-block position-relative bottom-0 w-100 d-flex flex-column flex-md-row justify-content-between mt-5 pt-3">
            <div class="d-flex justify-content-center align-items-center text-light py-1">
                <img class="z-index-2" src="<?php echo e(asset('public/assets/admin/img/certified.png')); ?>"
                      alt="Image Description" style="max-height: 50px;max-width: 200px">
            ...
            <div class="d-flex justify-content-center align-items-center text-light py-1">
                ...
                <img class="z-index-2 order-1 order-md-2" src="<?php echo e(asset('public/assets/admin/img/secure.png')); ?>"
                      alt="Image Description" style="max-height: 50px;max-width: 200px">
            </div>
        </footer>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/vendor-views/auth/login.blade.php ENDPATH**/ ?>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"> <?php echo e(__('messages.service')); ?> <?php echo e(__('messages.list')); ?><span class="badge badge-soft-dark ml-2" id="foodCount"><?php echo e($services->total()); ?></span></h1>
                </div>
                ...
                <div class="col-sm-auto" style="min-width: 306px;">
                    <select name="restaurant_id" id="restaurant" onchange="set_restaurant_filter('<?php echo e(url()->full()); ?>',this.value)" data-placeholder="<?php echo e(__('messages.select')); ?> <?php echo e(__('messages.vendor')); ?>" class="js-data-example-ajax form-control" onchange="getRestaurantData('<?php echo e(url('/')); ?>/admin/vendor/get-addons?data[]=0&restaurant_id=',this.value,'add_on')" required title="Select Vendor" oninvalid="this.setCustomValidity('<?php echo e(__('messages.please_select_restaurant')); ?>')">
                    <?php if($restaurant): ?>    
                    <option value="<?php echo e($restaurant->id); ?>" selected><?php echo e($restaurant->name); ?></option>
                    <?php else: ?>
                    <option value="all" selected><?php echo e(__('messages.all_vendors')); ?></option>
                    <?php endif; ?>
                    </select>
                </div>
            </div>
                    ...
                    <div class="table-responsive datatable-custom" id="table-div">
                        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                            ...
                            <tr>
                                ...
                                <th style="width: 15%"><?php echo e(__('messages.vendor')); ?></th>
                            ...
                            <tbody id="set-rows">
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($key+$services->firstItem()); ?></td>
                                    <td>
                                        <a class="media align-items-center" href="<?php echo e(route('admin.service.view',[$food['id']])); ?>">
                                    ...
                                    <td>
                                    <?php echo e($food->vendor?$food->vendor->names():__('messages.vendor').' '.__('messages.deleted')); ?>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox<?php echo e($food->id); ?>">
                                            <input type="checkbox" onclick="location.href='<?php echo e(route('admin.service.status',[$food['id'],$food->status?0:1])); ?>'"class="toggle-switch-input" id="stocksCheckbox<?php echo e($food->id); ?>" <?php echo e($food->status?'checked':''); ?>>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="<?php echo e(route('admin.service.edit',[$food['id']])); ?>" title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('messages.service')); ?>"><i class="tio-edit"></i>
                                        </a>
                                        <a class="btn btn-sm btn-white" href="javascript:"
                                            onclick="form_alert('food-<?php echo e($food['id']); ?>','<?php echo e(__('messages.Want_to_delete_this_item')); ?>')" title="<?php echo e(__('messages.delete')); ?> <?php echo e(__('messages.service')); ?>"><i class="tio-delete-outlined"></i>
                                        </a>
                                        <form action="<?php echo e(route('admin.service.delete',[$food['id']])); ?>"
                        ...
                        <div class="page-area">
                            <table>
                                ...
                                <?php echo $services->withQueryString()->links(); ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/admin-views/product/list.blade.php ENDPATH**/ ?>
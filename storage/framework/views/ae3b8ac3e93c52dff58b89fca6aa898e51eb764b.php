<?php $__env->startSection('title','Add new Service zone'); ?>
    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-add-circle-outlined"></i> <?php echo e(__('messages.add')); ?> <?php echo e(__('messages.new')); ?> <?php echo e(__('messages.service')); ?> <?php echo e(__('messages.zone')); ?>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="<?php echo e(route('admin.zone.store')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="<?php echo e(__('messages.new_zone')); ?>" value="<?php echo e(old('name')); ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="input-label"
                                       for="exampleFormControlInput1">Coordinates<span class="input-label-secondary" title="<?php echo e(__('messages.draw_your_zone_on_the_map')); ?>"><?php echo e(__('messages.draw_your_zone_on_the_map')); ?></span></label>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 my-lg-2">
                <div class="card">
                    <div class="card-header">
                        <h5><?php echo e(__('messages.zone')); ?> <?php echo e(__('messages.list')); ?><span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($zones->total()); ?></span></h5>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th ><?php echo e(__('messages.vendors')); ?></th>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/admin-views/zone/index.blade.php ENDPATH**/ ?>
                        ...
                        <!-- Notification -->
                          ...
                          <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="<?php echo e(route('vendor.notification.index')); ?>">
                                ...
                                <?php ($message=\App\Models\VendorNotification::where('is_seen',0)->where('vendor_id', auth('vendor')->id())->count()); ?>
                                    ...
                                    <span class="btn-status btn-sm-status btn-status-danger" style="display: inline-block;z-index: 100;height: 20px; width: 20px"><?php echo e($message); ?></span>
...
<?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/layouts/vendor/partials/_header.blade.php ENDPATH**/ ?>
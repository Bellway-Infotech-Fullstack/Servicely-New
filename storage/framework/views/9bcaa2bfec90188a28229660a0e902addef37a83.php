            ...
            <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($detail->service  && $detail->status): ?>
                            <!-- Media -->
                                <div class="media">
                                <?php if($editing): ?>
                                    <div class="avatar avatar-xl mr-3 cursor-pointer" onclick="quick_view_cart_item(<?php echo e($key); ?>)" title="<?php echo e(__('messages.click_to_edit_this_item')); ?>">
                                ...
                                <?php else: ?>
                                    <a class="avatar avatar-xl mr-3" href="<?php echo e(route('admin.service.view', $detail->service['id'])); ?>">
                                        <img class="img-fluid"
                                             src="<?php echo e(asset('storage/app/public/product')); ?>/<?php echo e($detail->service['image']); ?>"
                                             onerror="this.src='<?php echo e(asset('public/assets/admin/img/160x160/img2.jpg')); ?>'"
                                             alt="Image Description">
                        ...
                        <?php elseif($detail->campaign  && $detail->status): ?>
                            <!-- Media -->
                                <div class="media">
                                    <?php if($editing): ?>
                                    <div class="avatar avatar-xl mr-3  cursor-pointer" onclick="quick_view_cart_item(<?php echo e($key); ?>)" title="<?php echo e(__('messages.click_to_edit_this_item')); ?>">
                                    ...
                                    <?php else: ?>
                                    <a class="avatar avatar-xl mr-3" href="<?php echo e(route('admin.campaign.view', ['item', $detail->campaign['id']])); ?>">
                                        <img class="img-fluid"
                                             src="<?php echo e(asset('storage/app/public/campaign')); ?>/<?php echo e($detail->campaign['image']); ?>"
                                             onerror="this.src='<?php echo e(asset('public/assets/admin/img/160x160/img2.jpg')); ?>'"
                                             alt="Image Description">
                    ...
                    <?php if($order->customer): ?>
                        <div class="card-body">
                            ...
                            <a class="media align-items-center deco-none" href="<?php echo e(route('admin.customer.view',[$order->customer['id']])); ?>">    
                                ...
                                <div class="media-body">
                                    <span class="text-body text-hover-primary"><?php echo e($order->customer['f_name'].' '.$order->customer['l_name']); ?></span><br>
                                    <span class="badge badge-ligh"><?php echo e($order->customer->orders->count()); ?> <?php echo e(__('messages.orders')); ?></span>
                                </div>
                            ...
                            <ul class="list-unstyled list-unstyled-py-2">
                                ...
                                <li>
                                        ...
                                        <?php $__currentLoopData = $order->customer->addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <div class="deco-none" >
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(\App\Models\BusinessSetting::where('key', 'map_api_key')->first()->value); ?>&v=3.45.8"></script>
    <script>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/admin-views/order/order-view.blade.php ENDPATH**/ ?>
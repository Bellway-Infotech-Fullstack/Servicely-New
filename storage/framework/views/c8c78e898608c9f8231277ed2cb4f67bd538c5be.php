...
<div id="sidebarMain" class="d-none">
    <aside
        ...
        <div class="navbar-vertical-container">
            ...
            <!-- Content -->
            <div class="navbar-vertical-content" style="background-color: #019842 ;">
                ...
                <!-- End Orders -->
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                               title="<?php echo e(__('messages.vendor')); ?> <?php echo e(__('messages.section')); ?>"><?php echo e(__('messages.vendor')); ?> <?php echo e(__('messages.management')); ?></small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('zone')): ?>
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/zone*')?'active':''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="<?php echo e(route('admin.zone.home')); ?>" title="<?php echo e(__('messages.zone')); ?>">
                                <i class="tio-city nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    <?php echo e(__('messages.delivery_zone')); ?>                                </span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e((Request::is('admin/vendor*') && !Request::is('admin/vendor/withdraw_list'))?'active':''); ?>">
                        ...
                        >
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(__('messages.vendors')); ?></span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/vendor/add')?'active':''); ?>">
                                ...
                                title="<?php echo e(__('messages.register')); ?> <?php echo e(__('messages.vendor')); ?>"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <?php echo e(__('messages.add')); ?> <?php echo e(__('messages.vendor')); ?>
                            ...
                            <li class="navbar-item <?php echo e(Request::is('admin/vendor/list')?'active':''); ?>">
                                ...
                                title="<?php echo e(__('messages.vendor')); ?> <?php echo e(__('messages.list')); ?>"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(__('messages.vendors')); ?> <?php echo e(__('list')); ?></span>
                                </a>
                            </li>
                                ...
                                <li class="nav-item <?php echo e(Request::is('admin/campaign/basic/*')?'active':''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.campaign.list', 'basic')); ?>"
                                       title="<?php echo e(__('messages.basic_campaign')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate"><?php echo e(__('messages.basic_campaign')); ?></span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo e(Request::is('admin/campaign/item/*')?'active':''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.campaign.list', 'service_campaigns')); ?>"
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('withdraw_list')): ?>
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/vendor/withdraw*')?'active':''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               ...
                               title="<?php echo e(__('messages.vendor')); ?> <?php echo e(__('messages.withdraws')); ?>"
                            >
                                <i class="tio-table nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(__('messages.vendor')); ?> <?php echo e(__('messages.withdraws')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                <!-- End withdraw -->
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('report')): ?>
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/report/food-wise-report')?'active':''); ?>">
                            <a class="nav-link " href="<?php echo e(route('admin.report.food-wise-report')); ?>"
                               title="<?php echo e(__('messages.service_wise_report')); ?>">
                                <span class="tio-report nav-icon"></span>
                                <span
                                    class="text-truncate"><?php echo e(__('messages.service_wise_report')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/layouts/admin/partials/_sidebar.blade.php ENDPATH**/ ?>
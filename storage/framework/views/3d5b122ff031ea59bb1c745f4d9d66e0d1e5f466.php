...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('public/assets/landing')); ?>/image/logo_no_bg.png">
    ...
    <!-- fontawesome -->
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/landing/fontawesome/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/landing/fontawesome/css/fontawesome.min.css')); ?>">

    <!-- Normalize CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/landing')); ?>/css/normalize.css">
        ...
        <nav class="navbar navbar-expand-md">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
                    ...
                    <img  onerror="this.src='<?php echo e(asset('public/assets/admin/img/160x160/logo2.png')); ?>'"
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link navbar-font" href="<?php echo e(route('home')); ?>"><?php echo e(__('messages.home')); ?> <span
                                    class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navbar-font" href="<?php echo e($landing_page_links['web_app_url']); ?>"><?php echo e(__('messages.browse_web')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navbar-font" href="<?php echo e(route('terms-and-conditions')); ?>"><?php echo e(__('messages.terms_and_condition')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navbar-font" href="<?php echo e(route('about-us')); ?>"><?php echo e(__('messages.about_us')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navbar-font" href="<?php echo e(route('contact-us')); ?>"><?php echo e(__('messages.contact_us')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link navbar-font" href="<?php echo e(route('privacy-policy')); ?>"><?php echo e(__('messages.privacy_policy')); ?></a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right bg-color-primary" aria-labelledby="dropdownMenuButton">
                                <?php if($toggle_restaurant_registration): ?>
                                    <a class="dropdown-item navbar-font" href="<?php echo e(route('restaurant.create')); ?>">
                                ...
                                <?php endif; ?>
                                <?php if($toggle_dm_registration): ?>
                                    <a class="dropdown-item navbar-font" href="<?php echo e(route('deliveryman.create')); ?>">
                                        <?php echo e(__('messages.deliveryman_registration')); ?>
            ...
            <div class="container">
                ...
                <div class="row d-flex justify-content-center justify-content-md-start text-center text-md-left">
                    ...
                    <div class="col-lg-2 col-md-2 mb-md-0 footer-items">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="<?php echo e($landing_page_links['app_url_android']); ?>" class="footer-item text-white">Play Store</a>
                            </li>
                            <li class="mb-2">
                                <a href="<?php echo e($landing_page_links['app_url_ios']); ?>" class="footer-item text-white">App Store</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 mb-md-0 footer-items">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                <a href="mailto:<?php echo e(\App\CentralLogics\Helpers::get_settings('email_address')); ?>" class="footer-item text-white">
                                    <i class="fas fa-envelope MR-1"></i>
                                    <span class="ml-1"><?php echo e(\App\CentralLogics\Helpers::get_settings('email_address')); ?></span>
                                </a>
                            </li>
                            <li class="mb-2">
                                <a href="tel:<?php echo e(\App\CentralLogics\Helpers::get_settings('phone')); ?>" class="footer-item text-white">
...
<?php /**PATH C:\xampp\htdocs\servicely-new\resources\views/layouts/landing/app.blade.php ENDPATH**/ ?>